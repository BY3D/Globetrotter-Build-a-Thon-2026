...
In addition to the high quality classes I attended from Microsoft Reactor, I found Lee Stott's [Foundry Local Workshop](https://github.com/microsoft-foundry/Foundry-Local-Lab/) to be immensely useful in understanding how to create a web application with Foundry Local.